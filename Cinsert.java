...
import javax.swing.*;
import java.util.*;
public class Cinsert extends JFrame implements ActionListener{
  ...
  public void actionPerformed(ActionEvent e){
	...
	String country=jt12.getText();
		...
		st.execute("insert into company (cid,emailid,fname,lname,address,mob,gender,10th,12th,branch,back,no_of_back,country) values('"+cid+"','"+email+"','"+fnm+"','"+lnm+"','"+add+"','"+mob+"','"+g+"','"+ten+"','"+twlth+"','"+branch+"','"+b+"','"+nbk+"','"+country+"')");
		  	cn.close();
	   }
	    catch(Exception e1){
