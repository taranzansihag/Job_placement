...
import javax.swing.*;
import java.util.*;
public class Sinsert extends JFrame implements ActionListener{
 ...
 JLabel jl,jl1,jl2,jl3,jl4,jl5,jl6,jl7,jl8,jl9,jl10,jl11,jl12;
  ...
  public Sinsert(String s){
	super(s);
	setLayout(null);
	jl=new JLabel("Sid");
	jl1=new JLabel("Email_id");
  ...
  public void actionPerformed(ActionEvent e){
	...
	String country=jt12.getText();
		...
		if(e.getSource()==jb){
					...
					st.execute("insert into student (sid,emailid,fname,lname,address,mob,gender,10th,12th,branch,back,no_of_back,country) values('"+sid+"','"+email+"','"+fnm+"','"+lnm+"','"+add+"','"+mob+"','"+g+"','"+ten+"','"+twlth+"','"+branch+"','"+b+"','"+nbk+"','"+country+"')");
